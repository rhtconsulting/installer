...
func (a *OfflinePackage) Load(f asset.FileFetcher) (found bool, err error) {
	...
	rhcosMeta.createOfflinePackage(config.Rhcos.Url, "/ocp-images/")
	mirrorRelease.pullMirrorImages()
	mirrorRelease.extractInstaller()
	isoImage.createISOImage("/ocp-images/", "offline-ocp4-components.iso")
